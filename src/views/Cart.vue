    ...
    <div>
        ...
        <b-container fluid class="mt-4">
            ...
            <b-row class="text-center" v-if="cart.length > 0">
                ...
                <b-col><h3>R$ {{ total }}.00</h3></b-col>
            </b-row>
            <b-row class="mt-4 text-center" v-if="cart.length > 0">
                <b-col>
                    <b-button @click="clean" variant="info" block class="mr-2">Limpar</b-button>
                </b-col>
                <b-col></b-col>
                <b-col cols="4">Frutaria 2 Irmãos</b-col>
                <b-col></b-col>
            ...
            <b-modal hide-header-close no-close-on-esc no-close-on-backdrop ref="modal-1" centered title="Purchase Completed">
                <template slot="modal-footer">
                    <b-button class="mt-3" variant="info" block @click="clean">Fechar</b-button>
                </template>
                ...
                <h2 class="my-4 text-center">Total: R${{ticket.total}}.00</h2>
            </b-modal>
        </b-container>
    </div>
